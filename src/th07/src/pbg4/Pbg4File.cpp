...
{
#ifdef TH_PS4
    // Keep game archive paths relative. The PS4 fopen wrapper first checks the writable
    // /data/touhou/th07 directory and then falls back to the pkg's /app0/assets. Using
    // SDL_GetBasePath() here would incorrectly turn th07.dat into /app0/th07.dat.
