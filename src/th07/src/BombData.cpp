...
void BombData::BombReimuACalc(Player *player)
{
    ...
    if (bombInfo->bombTimer.HasTicked() && bombInfo->bombTimer == 0)
    {
        g_Gui.ShowBombNamePortrait(
            1185, THPatch_StringDef("th07 Bomb Reimu A unfocused", "霊符「夢想封印　散」"));
...
void BombData::BombReimuACalcFocus(Player *player)
{
    ...
    {
        g_Gui.ShowBombNamePortrait(
            1185, THPatch_StringDef("th07 Bomb Reimu A focused", "霊符「夢想封印　集」"));
...
void BombData::BombReimuBCalc(Player *player)
{
    ...
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(1185,
                                   THPatch_StringDef("th06 Bomb Reimu B", "夢符「封魔陣」"));
...
void BombData::BombReimuBCalcFocus(Player *player)
{
    ...
    if (player->bombInfo.bombTimer.HasTicked() && player->bombInfo.bombTimer == 0)
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1185, THPatch_StringDef("th07 Bomb Reimu B focused", "夢符「二重結界」"));
...
void BombData::BombMarisaACalc(Player *player)
{
    ...
    if (player->bombInfo.bombTimer.HasTicked() && player->bombInfo.bombTimer == 0)
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1187, THPatch_StringDef("th06 Bomb Marisa A", "魔符「スターダストレヴァリエ」"));
...
void BombData::BombMarisaACalcFocus(Player *player)
{
    ...
    if (player->bombInfo.bombTimer.HasTicked() && player->bombInfo.bombTimer == 0)
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1186, THPatch_StringDef("th07 Bomb Marisa A focused", "魔符「ミルキーウェイ」"));
...
void BombData::BombMarisaBCalc(Player *player)
{
    ...
    if (player->bombInfo.bombTimer.HasTicked() && player->bombInfo.bombTimer == 0)
    {
        ...
        g_Gui.ShowBombNamePortrait(
            1185,
            THPatch_StringDef("th07 Bomb Marisa B unfocused", "恋符「ノンディレクショナルレーザー」"));
...
void BombData::BombMarisaBCalcFocus(Player *player)
{
    ...
    if (player->bombInfo.bombTimer.HasTicked() && player->bombInfo.bombTimer == 0)
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1186, THPatch_StringDef("th06 Bomb Marisa B", "恋符「マスタースパーク」"));
...
void BombData::BombSakuyaACalc(Player *player)
{
    ...
    if (player->GetBombTimer()->HasTickedAndIsEq(0))
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1185, THPatch_StringDef("th07 Bomb Sakuya A unfocused", "幻符「インディスクリミネイト」"));
...
void BombData::BombSakuyaACalcFocus(Player *player)
{
    ...
    if (player->GetBombTimer()->HasTickedAndIsEq(0))
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1185, THPatch_StringDef("th07 Bomb Sakuya A focused", "幻符「殺人ドール」"));
...
void BombData::BombSakuyaBCalc(Player *player)
{
    ...
    if (player->GetBombTimer()->HasTickedAndIsEq(0))
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1187, THPatch_StringDef("th07 Bomb Sakuya B unfocused", "時符「パーフェクトスクウェア」"));
        player->bombInfo.bombDuration = 160;
...
void BombData::BombSakuyaBCalcFocus(Player *player)
{
    ...
    if (player->GetBombTimer()->HasTickedAndIsEq(0))
    {
        g_ItemManager.RemoveAllItems();
        g_Gui.ShowBombNamePortrait(
            1187, THPatch_StringDef("th07 Bomb Sakuya B focused", "時符「プライベートスクウェア」"));
        player->bombInfo.bombDuration = 300;
