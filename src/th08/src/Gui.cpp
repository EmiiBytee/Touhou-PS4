...
{
#ifdef TH_PS4
    // Breadcrumb: the spell practice retry crashes somewhere along this path.
    g_GameErrorContext.Log("ps4 retry: CaptureArcade anm=%p\r\n", (void *)g_AsciiManager.captureAnm);
#endif
    g_AsciiManager.captureAnm->SetAndExecuteScriptIdx(&this->impl->arcadeCaptureVm, 1);
#ifdef TH_PS4
    g_GameErrorContext.Log("ps4 retry: CaptureArcade sprite=%p\r\n",
                           (void *)this->impl->arcadeCaptureVm.loadedSprite);
#endif
