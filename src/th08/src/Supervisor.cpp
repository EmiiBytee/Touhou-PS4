...
#ifdef TH_PS4
                g_GameErrorContext.Log("ps4 retry: restart, cutting chain\r\n");
#endif
                GameManager::CutChain();
#ifdef TH_PS4
                g_GameErrorContext.Log("ps4 retry: chain cut, registering\r\n");
#endif
...
#ifdef TH_PS4
                g_GameErrorContext.Log("ps4 retry: chain registered\r\n");
#endif
                s->curState = SupervisorState_GameManager;
                break;
