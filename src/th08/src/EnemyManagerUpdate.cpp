    ...
    run_enemy_ecl_after_pause:
        ...
        process_enemy_death:
            ...
            common_death_mode:
                ...
                // Target jump table 0x42de96: mode 2 enters at 0x42d8ee, after the boss block
                // above (0x42d8c8..0x42d8e9), which only modes 0 and 1 run. A boss phase that
                // ends in this mode keeps its life bar and attached effects -- the next phase's
                // script (IN's stage bosses use it between cards) never re-announces the boss.
