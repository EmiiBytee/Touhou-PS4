...
const ControllerMapping g_DefaultControllerMapping = {
...
ControllerMapping g_ControllerMapping = g_DefaultControllerMapping;
...
#ifdef TH_PS4
        g_PS4Widescreen = g_Supervisor.cfg.windowed != 0;
        // Directions are not rebindable on PS4 (see MainMenu keyconfig); repair configs
        // scrambled by older builds so the D-pad always navigates.
        g_Supervisor.cfg.controllerMapping.upButton = g_DefaultControllerMapping.upButton;
        g_Supervisor.cfg.controllerMapping.downButton = g_DefaultControllerMapping.downButton;
        g_Supervisor.cfg.controllerMapping.leftButton = g_DefaultControllerMapping.leftButton;
        g_Supervisor.cfg.controllerMapping.rightButton = g_DefaultControllerMapping.rightButton;
#endif
