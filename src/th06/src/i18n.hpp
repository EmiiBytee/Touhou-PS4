...
#ifdef TH_THPATCH
// Visible strings come from the thcrap translation patch when one is installed
// (stringdefs.js ids), falling back to the original Japanese.
#include "thpatch.hpp"
#undef TH_REIMU_A_BOMB_NAME
#undef TH_REIMU_B_BOMB_NAME
#undef TH_MARISA_A_BOMB_NAME
#undef TH_MARISA_B_BOMB_NAME
#define TH_REIMU_A_BOMB_NAME THPatch_StringDef("th06 Bomb Reimu A", TH_JP_REIMU_A_BOMB_NAME)
#define TH_REIMU_B_BOMB_NAME THPatch_StringDef("th06 Bomb Reimu B", TH_JP_REIMU_B_BOMB_NAME)
#define TH_MARISA_A_BOMB_NAME THPatch_StringDef("th06 Bomb Marisa A", TH_JP_MARISA_A_BOMB_NAME)
#define TH_MARISA_B_BOMB_NAME THPatch_StringDef("th06 Bomb Marisa B", TH_JP_MARISA_B_BOMB_NAME)
#endif
