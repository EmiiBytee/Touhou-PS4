...
#ifdef TH_PS4
    // SDL has no keyboard driver on the PS4, so a USB keyboard is read from the console's
    // own service and merged here: pad and keyboard both work, at the same time.
    buttons |= PS4_KeyboardButtons();
#endif
