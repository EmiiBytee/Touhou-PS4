...
#ifdef TH_PS4
// On PS4 the "windowed" option selects the aspect ratio at runtime instead:
// 0 = 4:3 pillarboxed, 1 = stretched to the full 16:9 screen.
extern bool g_PS4Widescreen;
#define TH_PS4_PILLARBOX_WIDTH ((u32)((GAME_WINDOW_HEIGHT_REAL / 3.0f) * 4.0f))
#undef VIEWPORT_WIDTH
#undef VIEWPORT_OFF_X
#undef VIEWPORT_HEIGHT
#undef VIEWPORT_OFF_Y
#define VIEWPORT_WIDTH (g_PS4Widescreen ? (u32)GAME_WINDOW_WIDTH_REAL : TH_PS4_PILLARBOX_WIDTH)
#define VIEWPORT_OFF_X (g_PS4Widescreen ? 0 : (i32)(GAME_WINDOW_WIDTH_REAL - TH_PS4_PILLARBOX_WIDTH) / 2)
#define VIEWPORT_HEIGHT GAME_WINDOW_HEIGHT_REAL
#define VIEWPORT_OFF_Y 0
#endif
